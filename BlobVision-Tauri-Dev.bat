@echo off
chcp 65001 >nul 2>&1
title BlobVision - Tauri (DEV)
cd /d "%~dp0tauri"

echo.
echo  BlobVision - Tauri - MODE DEV (recompile a chaque lancement, ~1-2 min).
echo  Pour juste lancer l'app rapidement, utilise BlobVision-Tauri.bat a la place.
