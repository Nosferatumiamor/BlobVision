...
BlobVision was entirely Vibe Coded, using ChatGPT, Cursor, Open Code, and
Claude in succession. This is a computer user's project, not a developer's;
the program has been through plenty of testing and revisions, but not only
is this V1 far from perfectly debugged, its code and inner workings might
still be full of inconsistencies and rotten robot-generated leftovers I'm
not equipped to catch... because I'm an idiot. Consider yourself warned.
...
responsibility. Now, let's be serious for a minute: don't use this program
to generate criminal, defamatory, pedophilic shit or fascist propaganda.
You're not a trillionaire or an American president. You're better than that.
